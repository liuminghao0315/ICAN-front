...
// 功能色
$success-color: #67C23A;  // 成功/低风险
$warning-color: #E6A23C;  // 警告/中风险
$danger-color: #F56C6C;   // 危险/高风险
...
```scss
// 风险等级颜色
$risk-low: #67C23A;      // 低风险 - 绿色
$risk-medium: #E6A23C;   // 中风险 - 橙色
$risk-high: #F56C6C;     // 高风险 - 红色
...
### 5. 分析结果详情页 (ResultDetailView.vue)
...
export function useWebSocket() {
  ...
  function connect() {
    ...
    const wsUrl = `ws://localhost:8080/ws/task-progress/${authStore.userId}`;
  ...
  function attemptReconnect() {
    if (reconnectCount.value < maxReconnect) {
      ...
      console.log(`尝试重连 (${reconnectCount.value}/${maxReconnect})...`);
...
const routes = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: '我的视频' },
  },
  {
    path: '/videos/upload',
    name: 'VideoUpload',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: '视频详情' },
  },
  {
    path: '/tasks',
    name: 'TaskList',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, title: '分析结果' },
  },
  {
    path: '/results/:id',
    name: 'ResultDetail',
    component: () => import('@/views/result/ResultDetailView.vue'),
    meta: { requiresAuth: true, title: '结果详情' },
  },
];
...
const pieOption = {
  ...
  series: [{
    ...
    radius: ['40%', '70%'],
    data: [
      { value: 8, name: '低风险', itemStyle: { color: '#67C23A' } },
